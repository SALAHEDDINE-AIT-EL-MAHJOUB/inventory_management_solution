        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Client_AspNetUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ville_Region_RegionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Societé_VilleId = table.Column<int>(type: "int", nullable: true, comment: "Clé étrangère qui fait référence à la table Ville (par exemple, pour stocker l'ID de la ville où se trouve la société)."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Rack_Id = table.Column<int>(type: "int", nullable: false, comment: "Identifiant unique pour chaque rack")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rack_Nom = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true, comment: "Nom du rack"),
                    Rack_AlleeId = table.Column<int>(type: "int", nullable: true, comment: "Référence à l'identifiant de l'Allee dans laquelle le rack est situé. C'est une clé étrangère."),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rack__3B72075B69B2E97F", x => x.Rack_Id);
                    table.ForeignKey(
                        name: "Rack_AlleeId",
                        column: x => x.Rack_AlleeId,
                        principalTable: "Allee",
                        principalColumn: "Allee_Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodeBarreRack_Id = table.Column<int>(type: "int", nullable: false, comment: "Identifiant unique pour chaque association entre un code-barres et un rack.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodeBarreRack_RackId = table.Column<int>(type: "int", nullable: true, comment: "Référence à l'identifiant du rack avec ce code-barres est situé. C'est une clé étrangère."),
                    Code = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__CodeBarr__4A88C0C48D7878BA", x => x.CodeBarreRack_Id);
                    table.ForeignKey(
                        name: "CodeBarreRack_RackId",
                        column: x => x.CodeBarreRack_RackId,
                        principalTable: "Rack",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rangée_RackId = table.Column<int>(type: "int", nullable: true, comment: "Référence à l'identifiant du rack dans lequel la rangée est située. C'est une clé étrangère"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Produit_Id = table.Column<int>(type: "int", nullable: false, comment: "Identifiant unique pour chaque produit.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nom = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Produit_Prix = table.Column<decimal>(type: "decimal(10,2)", nullable: false, comment: "Prix du produit."),
                    Produit_EtageId = table.Column<int>(type: "int", nullable: true, comment: "Référence à l'identifiant de l'étage où le produit est stocké. C'est une clé étrangère."),
                    QuantiteEnStock = table.Column<int>(type: "int", nullable: true),
                    CodeBarreEtageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Produit__DBDF7B2C20682064", x => x.Produit_Id);
                    table.ForeignKey(
                        name: "FK_Produit_CodeBarreEtage_CodeBarreEtageId",
                        column: x => x.CodeBarreEtageId,
                        principalTable: "CodeBarreEtage",
                        principalColumn: "CodeBarreEtage_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "Produit_EtageId",
                        column: x => x.Produit_EtageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FormProduit_ProduitId = table.Column<int>(type: "int", nullable: false, comment: "Référence à l'identifiant du produit parent. C'est une clé étrangère."),
                    FormProduit_Id = table.Column<int>(type: "int", nullable: false, comment: "Identifiant unique pour chaque forme de produit"),
                    FormProduit_CodeBarre = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true, comment: "Code-barres unique pour identifier cette forme spécifique du produit."),
                    FormProduit_Quantite = table.Column<int>(type: "int", nullable: true, comment: "Quantité disponible de cette forme du produit.")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__FormProd__277478DA1E43E773", x => x.FormProduit_ProduitId);
                    table.ForeignKey(
                        name: "FormProduit_ProduitId",
                        column: x => x.FormProduit_ProduitId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ResultatInventaire_Id = table.Column<int>(type: "int", nullable: false, comment: "Identifiant unique pour chaque enregistrement de résultat d'inventaire.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Id = table.Column<int>(type: "int", nullable: false),
                    FormProduitId = table.Column<int>(type: "int", nullable: false),
                    ResultatInventaire_FormProduitId = table.Column<int>(type: "int", nullable: true, comment: "Référence à l'identifiant du produit formulé, lié à la table FormProduit."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResultatInventaire_FormProduit_FormProduitId",
                        column: x => x.FormProduitId,
                        principalTable: "FormProduit",
                        principalColumn: "FormProduit_ProduitId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Equipe_Id");
                    table.ForeignKey(
                        name: "ResultatInventaire_FormProduitId",
                        column: x => x.ResultatInventaire_FormProduitId,
                        principalTable: "FormProduit",
                        principalColumn: "FormProduit_ProduitId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeBarreOperateur_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeBarreRack_CodeBarreRack_RackId",
                table: "CodeBarreRack",
                column: "CodeBarreRack_RackId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeBarreRangée_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produit_CodeBarreEtageId",
                table: "Produit",
                column: "CodeBarreEtageId");

            migrationBuilder.CreateIndex(
                name: "IX_Produit_Produit_EtageId",
                table: "Produit",
                column: "Produit_EtageId");

            migrationBuilder.CreateIndex(
                name: "IX_Rack_Rack_AlleeId",
                table: "Rack",
                column: "Rack_AlleeId");

            migrationBuilder.CreateIndex(
                name: "IX_Rangee_Rangée_RackId",
                table: "Rangee",
                column: "Rangée_RackId");

            migrationBuilder.CreateIndex(
                name: "IX_ResultatInventaire_FormProduitId",
                table: "ResultatInventaire",
                column: "FormProduitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResultatInventaire_ResultatInventaire_FormProduitId",
                table: "ResultatInventaire",
                column: "ResultatInventaire_FormProduitId");
