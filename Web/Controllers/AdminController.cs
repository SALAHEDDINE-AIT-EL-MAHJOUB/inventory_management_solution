...
namespace Web.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        // Supprimer cette méthode car elle sera dans AuthController
        // [HttpPost("login")]
        // public async Task<ActionResult> Login([FromBody] AdminLoginModel model)
        // {
        //     // Code supprimé - utiliser AuthController à la place
        // }

        // Ajouter une méthode pour récupérer le dashboard admin
        ...
        public async Task<ActionResult> GetAdminDashboard()
        {
            ...
            if (admin == null)
                return NotFound("Profil admin non trouvé");

            // Statistiques pour le dashboard admin
            var totalClients = (await _clientService.GetAllAsync()).Count();
            var activeClients = (await _clientService.GetAllAsync()).Count(c => c.IsActive);
